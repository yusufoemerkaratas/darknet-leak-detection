...
def process_file(db, filepath: Path) -> bool:
    ...
    try:
        ...
        analysis = _analysis_engine.analyze(full_body_text)

        # Source and company
        source = get_or_create_source(
            db, doc.get("forum_id", "unknown"), doc.get("source_url", "")
        )
        company_name = analysis.best_company_name or "Unknown"
        ...
        analysis_result = AnalysisResult(
            ...
            terminology_hits   = analysis.terminology_hits,
            score_contributors = analysis.score_breakdown,
            classification_rule = analysis.classification_rule,
        )
