...
```
cd existing_repo
git remote add origin https://git.fiw.fhws.de/programmier-projekte/ki-gestuetztes-system-zur-fruehzeitigen-erkennung-von-datenlecks.git
git branch -M main
...
* [Set up project integrations](https://git.fiw.fhws.de/programmier-projekte/ki-gestuetztes-system-zur-fruehzeitigen-erkennung-von-datenlecks/-/settings/integrations)
...
>>>>>>> c21b919 (feat: initial backend setup with FastAPI, PostgreSQL, Docker and Alembic migrations)
