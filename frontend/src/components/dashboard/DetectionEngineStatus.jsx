      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="rounded-[12px] border border-slate-800/80 bg-slate-950/45 px-3 py-2 text-[12px]">
            <p className="text-[10px] uppercase tracking-[0.14em] text-slate-500">Analyzed</p>
            <p className="mt-1 text-slate-100">{analyzedFindings}</p>
          </div>
          <div className="rounded-[12px] border border-slate-800/80 bg-slate-950/45 px-3 py-2 text-[12px]">
            <p className="text-[10px] uppercase tracking-[0.14em] text-slate-500">Pending</p>
            <p className="mt-1 text-slate-100">{pendingFindings}</p>
          </div>
        </div>

        <DetectionGaugeChart label="Analysis Coverage" value={analysisCoverage} />
      </div>
    </StatusCard>
  )
}
